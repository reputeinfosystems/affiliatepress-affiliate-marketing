    ...
    class affiliatepress_woocommerce Extends AffiliatePress_Core{
        ...
        */
        ...
        function affiliatepress_insert_pending_commission_from_woocommerce($affiliatepress_order){
            ...
            $affiliatepress_affiliate_id = apply_filters( 'affiliatepress_get_affiliate_id', $affiliatepress_affiliate_id, $this->affiliatepress_integration_slug, $affiliatepress_order_data ,$affiliatepress_order ,$affiliatepress_customer_args);
            ...
            */
            ...
            $affiliatepress_visit_id = apply_filters( 'affiliatepress_get_visit_id', $affiliatepress_visit_id,$affiliatepress_affiliate_id, $this->affiliatepress_integration_slug, $affiliatepress_order_id ,$affiliatepress_order ,$affiliatepress_args, $affiliatepress_commission_rules,$affiliatepress_customer_args);
