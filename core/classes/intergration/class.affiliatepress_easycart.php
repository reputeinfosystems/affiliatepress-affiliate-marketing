    ...
    class affiliatepress_easycart Extends AffiliatePress_Core{
        ...
        */
        ...
        public function affiliatepress_add_pending_referral_easycart( $affiliatepress_order_id, $affiliatepress_cart, $affiliatepress_order_totals, $affiliatepress_user, $affiliatepress_payment_type ){
            ...
            $affiliatepress_affiliate_id = apply_filters( 'affiliatepress_get_affiliate_id', $affiliatepress_affiliate_id, $this->affiliatepress_integration_slug, array('order_id'=>$affiliatepress_order_id) , $affiliatepress_order_details ,$affiliatepress_customer_args );
            ...
            $affiliatepress_visit_id = apply_filters( 'affiliatepress_get_visit_id', $affiliatepress_visit_id, $affiliatepress_affiliate_id, $this->affiliatepress_integration_slug, array('order_id'=>$affiliatepress_order_id) ,$affiliatepress_order_details ,$affiliatepress_args, $affiliatepress_commission_rules,$affiliatepress_customer_args); 
            ...
            $affiliatepress_commission_data  = apply_filters( 'affiliatepress_before_commission_insert',$affiliatepress_commission_data,$affiliatepress_order_details, $affiliatepress_commission_rules);
