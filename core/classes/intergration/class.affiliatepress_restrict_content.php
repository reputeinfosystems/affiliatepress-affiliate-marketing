    ...
    class affiliatepress_restrict_content Extends AffiliatePress_Core{
        ...
        */
        function __construct(){            
            ...
            if($this->affiliatepress_restrict_content_commission_add() && $affiliatepress_is_restrict_content_active){
                ...
                add_action( 'rcp_update_payment_status_failed', array($this,'affiliatepress_reject_commission_on_fail_rcp'),10,1);
                add_action( 'rcp_update_payment_status_abandoned', array($this,'affiliatepress_reject_commission_on_fail_rcp'),10,1);

                // Update the status of the commission to "rejected" when the originating payment is refunded
                add_action( 'rcp_update_payment_status_refunded', array($this , 'affiliatepress_reject_commission_on_refund_rcp'), 10, 1 );
                ...
                add_action( 'rcp_delete_payment',array($this,'affiliatepress_reject_commission_on_delete_rcp'), 10, 2 );
        ...
        */
        ...
        function affiliatepress_accept_pending_commission_rcp( $affiliatepress_payment_id ) {
         ...
         /**
         * Function for add Reject commission settings
         *
         * @param  int $affiliatepress_payment_id
         * @return void
         */
        function affiliatepress_reject_commission_on_delete_rcp( $affiliatepress_payment_id ) {
        
            global $affiliatepress_commission_debug_log_id,$AffiliatePress,$affiliatepress_tbl_ap_affiliate_commissions ,$AffiliatePress;
                ...
                foreach($affiliatepress_all_commission_data as $affiliatepress_commission_data){
                    ...
                    if(!empty($affiliatepress_commission_data)){
                        ...
                        if($affiliatepress_ap_commission_id != 0){
                            ...
                            $affiliatepress_debug_log_msg = sprintf( 'Commission #%s successfully marked as rejected, after order #%s move to trash.', $affiliatepress_ap_commission_id, $affiliatepress_payment_id );
         ...
         * @return void
         */
        function affiliatepress_reject_commission_on_fail_rcp( $affiliatepress_payment_id ) {
                ...
                foreach($affiliatepress_all_commission_data as $affiliatepress_commission_data){
                    ...
                    if(!empty($affiliatepress_commission_data)){
                        ...
                        if($affiliatepress_ap_commission_id != 0){
                            ...
                            $affiliatepress_debug_log_msg = sprintf( ' Commission #%s successfully marked as rejected, after payment #%s failed.', $affiliatepress_ap_commission_id, $affiliatepress_payment_id );
       ...
       /**
         ...
         * @return void
         */
        function affiliatepress_reject_commission_on_refund_rcp( $affiliatepress_payment_id ) {
        
            global $AffiliatePress,$affiliatepress_tbl_ap_affiliate_commissions,$affiliatepress_commission_debug_log_id;
            $affiliatepress_reject_commission_on_refund = $AffiliatePress->affiliatepress_get_settings('restrict_content_reject_commission_on_refund', 'integrations_settings');
