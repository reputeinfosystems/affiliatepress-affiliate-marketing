...
if( !class_exists('affiliatepress_lifter_lms') ){
    ...
    class affiliatepress_lifter_lms Extends AffiliatePress_Core{
        ...
        */
        function __construct(){ 
            ...
            if($this->affiliatepress_lifter_lms_commission_add() && $affiliatepress_is_lifter_lms_active){
                ...
                add_action( 'lifterlms_order_status_refunded', array( $this, 'affiliatepress_revoke_referral_lifterlms' ), 10, 1 );
				add_action( 'lifterlms_order_status_cancelled', array( $this, 'affiliatepress_revoke_referral_lifterlms' ), 10, 1 );
				add_action( 'lifterlms_order_status_expired', array( $this, 'affiliatepress_revoke_referral_lifterlms' ), 10, 1 );
				add_action( 'lifterlms_order_status_trash', array( $this, 'affiliatepress_revoke_referral_lifterlms' ), 10, 1 );
        ...
        */
         ...
         * @return void
         */
        public function affiliatepress_revoke_referral_lifterlms( $affiliatepress_order ) {

            global $AffiliatePress,$affiliatepress_tbl_ap_affiliate_commissions,$affiliatepress_commission_debug_log_id;
            $affiliatepress_reject_commission_on_refund = $AffiliatePress->affiliatepress_get_settings('lifter_lms_reject_commission_on_refund', 'integrations_settings');
