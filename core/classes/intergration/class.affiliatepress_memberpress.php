        ...
        */
        function __construct(){         
            ...
            if($this->affiliatepress_memberpress_commission_add() && $affiliatepress_is_memberpress_active){
                ...
                add_action( 'mepr-txn-status-failed',array($this,'affiliatepress_reject_commission_on_fail_memberpress'),10,1);

                // Update the status of the commission to "rejected" when the originating transaction is refunded
                add_action( 'mepr-txn-status-refunded',array($this,'affiliatepress_reject_commission_on_refund_memberpress'),10,1);
                ...
                add_action( 'mepr_pre_delete_transaction',array($this,'affiliatepress_reject_commission_on_delete_memberpress'),10,1);
         ...
         * @return void
         */
        function affiliatepress_reject_commission_on_fail_memberpress( $affiliatepress_transaction ) {
                ...
                foreach($affiliatepress_all_commission_data as $affiliatepress_commissition_data){
                    ...
                    if(!empty($affiliatepress_commissition_data)){
                        ...
                        if($affiliatepress_ap_commission_id != 0){
                            ...
                            $affiliatepress_debug_log_msg = sprintf( 'Commission #%s successfully marked as rejected, after #%s transaction was failed.', $affiliatepress_ap_commission_id, $affiliatepress_transaction_id );
        
                            do_action('affiliatepress_commission_debug_log_entry', 'commission_tracking_debug_logs', $this->affiliatepress_integration_slug.' : Commission Reject ', 'affiliatepress_easy_digital_downloads_commission_tracking', $affiliatepress_debug_log_msg, $affiliatepress_commission_debug_log_id);
         ...
         * @return void
         */
        function affiliatepress_reject_commission_on_refund_memberpress( $affiliatepress_transaction ) {

            global $AffiliatePress,$affiliatepress_tbl_ap_affiliate_commissions,$affiliatepress_commission_debug_log_id;
            $affiliatepress_reject_commission_on_refund = $AffiliatePress->affiliatepress_get_settings('memberpress_reject_commission_on_refund', 'integrations_settings');
                ...
                foreach($affiliatepress_all_commission_data as $affiliatepress_commissition_data){
                    ...
                    if(!empty($affiliatepress_commissition_data)){
                        ...
                        if($affiliatepress_ap_commission_id != 0){
                            ...
                            $affiliatepress_debug_log_msg = sprintf( 'Commission #%s successfully marked as rejected, after  #%s was refunded.', $affiliatepress_ap_commission_id, $affiliatepress_transaction_id );
        ...
        /**
         * Function For Add reject commision
         *
         * @param  array $affiliatepress_transaction
         * @return void
         */
        function affiliatepress_reject_commission_on_delete_memberpress( $affiliatepress_transaction ) {
            global $AffiliatePress,$affiliatepress_tbl_ap_affiliate_commissions,$affiliatepress_commission_debug_log_id;
                ...
                foreach($affiliatepress_all_commission_data as $affiliatepress_commissition_data){
                    ...
                    if(!empty($affiliatepress_commissition_data)){
                        ...
                        if($affiliatepress_ap_commission_id != 0){
                            ...
                            $affiliatepress_debug_log_msg = sprintf( 'Commission #%s successfully marked as rejected, after payment #%s was delete.', $affiliatepress_ap_commission_id, $affiliatepress_transaction_id );
