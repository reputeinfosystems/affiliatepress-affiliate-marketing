    ...
    class affiliatepress_edd Extends AffiliatePress_Core{
        ...
        */
        ...
        function affiliatepress_edd_insert_payment($affiliatepress_order_id, $affiliatepress_order_data)
        {
            ...
            $affiliatepress_commission_types  = apply_filters( 'affiliatepress_modify_commission_type',$affiliatepress_commission_types,$affiliatepress_affiliate_id,  $affiliatepress_visit_id ,$this->affiliatepress_integration_slug ,$affiliatepress_order_id ,$affiliatepress_order_data, $affiliatepress_args, $affiliatepress_commission_rules,$affiliatepress_customer_args );
