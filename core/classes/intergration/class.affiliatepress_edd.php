...
if( !class_exists('affiliatepress_edd') ){
    ...
    class affiliatepress_edd Extends AffiliatePress_Core{
        ...
        */
        function __construct(){ 
            ...
            if($this->affiliatepress_edd_commission_add() && $affiliatepress_is_edd_active){
                ...
                add_action( 'edd_update_payment_status', array($this,'affiliatepress_reject_commission_on_trash_and_refund_edd'), 10, 3 );

                /** Add Reject Commission on delete */
                add_action( 'edd_payment_delete', array($this,'affiliatepress_reject_commission_on_delete_edd'), 10, 1 );
                ...
                /** Add Reject Commission on status change */
                add_action( 'edd_update_payment_status', array($this,'affiliatepress_reject_commission_on_failed_edd'), 10, 3 );
        ...
        */
        ...
        function affiliatepress_edd_insert_payment($affiliatepress_order_id, $affiliatepress_order_data)
        {
            ...
            if($affiliatepress_tracking->affiliatepress_is_commission_basis_per_order()){
                ...
                $affiliatepress_commission_rules    = $affiliatepress_tracking->affiliatepress_calculate_commission_amount(  $affiliatepress_amount, $affiliatepress_order_data['currency'], $affiliatepress_args );
        ...
        function affiliatepress_accept_pending_commission_edd( $affiliatepress_order_id ) {
            ...
            do_action('affiliatepress_commission_debug_log_entry', 'commission_tracking_debug_logs', $this->affiliatepress_integration_slug.' : Commission Approve ', 'affiliatepress_'.$this->affiliatepress_integration_slug.'_commission_tracking', $affiliatepress_order_id, $affiliatepress_commission_debug_log_id);
        ...
        /**
         * affiliatepress_reject_commission_on_trash_and_refund_edd
         *
         * @param  int $affiliatepress_order_id
         ...
         * @return void
         */
        public function affiliatepress_reject_commission_on_trash_and_refund_edd( $affiliatepress_order_id, $affiliatepress_new_status, $affiliatepress_old_status  ) {

            global $AffiliatePress,$affiliatepress_tbl_ap_affiliate_commissions,$affiliatepress_commission_debug_log_id;

            if ( $affiliatepress_new_status == 'refunded'  || $affiliatepress_new_status == "partially_refunded" )
            {
                do_action('affiliatepress_commission_debug_log_entry', 'commission_tracking_debug_logs', $this->affiliatepress_integration_slug.' : Commission Rejected ID ', 'affiliatepress_'.$this->affiliatepress_integration_slug.'_commission_tracking', $affiliatepress_order_id, $affiliatepress_commission_debug_log_id);

                $affiliatepress_reject_commission_on_refund = $AffiliatePress->affiliatepress_get_settings('easy_digital_downloads_reject_commission_on_refund', 'integrations_settings');
        ...
        /**
         * affiliatepress_reject_commission_on_delete_edd
         *
         * @param  int $affiliatepress_order_id
         * @return void
         */
        function affiliatepress_reject_commission_on_delete_edd($affiliatepress_order_id)
        {
            global $AffiliatePress,$affiliatepress_tbl_ap_affiliate_commissions,$affiliatepress_commission_debug_log_id;

            do_action('affiliatepress_commission_debug_log_entry', 'commission_tracking_debug_logs', $this->affiliatepress_integration_slug.' : Commission Deleted ID ', 'affiliatepress_'.$this->affiliatepress_integration_slug.'_commission_tracking', $affiliatepress_order_id, $affiliatepress_commission_debug_log_id);
                ...
                foreach($affiliatepress_all_commissition_data as $affiliatepress_commissition_data){
                    ...
                    if(!empty($affiliatepress_commissition_data)){
                        ...
                        if($affiliatepress_ap_commission_id != 0){
                            ...
                            $affiliatepress_debug_log_msg = sprintf( 'Commission #%s successfully marked as rejected, after order #%s was deleted.', $affiliatepress_ap_commission_id, $affiliatepress_order_id );
        ...
        */
        ...
        /**
         * affiliatepress_reject_commission_on_failed_edd
         *
         * @param  int $affiliatepress_order_id
         * @param  string $affiliatepress_new_status
         * @param  string $affiliatepress_old_status
         * @return void
         */
        function affiliatepress_reject_commission_on_failed_edd( $affiliatepress_order_id, $affiliatepress_new_status, $affiliatepress_old_status  ) {

            global $AffiliatePress,$affiliatepress_tbl_ap_affiliate_commissions,$affiliatepress_commission_debug_log_id;
    
            if ( $affiliatepress_new_status == 'failed'  || $affiliatepress_new_status == "abandoned"  || $affiliatepress_new_status == "revoked"){
                    ...
                    foreach($affiliatepress_all_commission_data as $affiliatepress_commission_data){
                        ...
                        if(!empty($affiliatepress_commission_data)){
                            ...
                            if($affiliatepress_ap_commission_id != 0){
                                ...
                                $affiliatepress_debug_log_msg = sprintf( 'Commission #%s successfully marked as rejected, after order #%s was failed.', $affiliatepress_ap_commission_id, $affiliatepress_order_id );
