...
if( !class_exists('affiliatepress_paid_memberships_subscriptions') ){
    ...
    class affiliatepress_paid_memberships_subscriptions Extends AffiliatePress_Core{
        ...
        */
        function __construct(){            
            ...
            if($this->affiliatepress_paid_memberships_subscriptions_commission_add() && $affiliatepress_is_paid_memberships_subscriptions_active){
                ...
                add_action( 'pms_payment_update', array($this,'affiliatepress_reject_commission_on_refund_pms'), 10, 3 );

                // Update the status of the commission to "rejected" when the originating payment is failed
                add_action( 'pms_payment_update', array($this,'affiliatepress_reject_commission_on_fail_pms'), 10, 3 );

                // Update the status of the commission to "rejected" when the originating payment is deleted
                add_action( 'pms_payment_delete', array($this , 'affiliatepress_reject_commission_on_delete_pms'), 10, 1 );
       ...
       function affiliatepress_add_product_commission_settings_pms() {
        ...
        /**
         * Function For reject commission add
         *
         * @param  int $affiliatepress_payment_id
         * @param  string $affiliatepress_new_data
         * @param  string $affiliatepress_old_data
         * @return void
         */
        function affiliatepress_reject_commission_on_refund_pms( $affiliatepress_payment_id, $affiliatepress_new_data, $affiliatepress_old_data ) {

            global $AffiliatePress,$affiliatepress_tbl_ap_affiliate_commissions,$affiliatepress_commission_debug_log_id;

            if ( ! isset( $affiliatepress_new_data['status'] ) || $affiliatepress_new_data['status'] != 'refunded' ){
                return;
            }

            $affiliatepress_reject_commission_on_refund = $AffiliatePress->affiliatepress_get_settings('paid_memberships_subscriptions_reject_commission_on_refund', 'integrations_settings');
                ...
                foreach($affiliatepress_all_commission_data as $affiliatepress_commissition_data){
                    ...
                    if(!empty($affiliatepress_commissition_data)){
                        ...
                        if($affiliatepress_ap_commission_id != 0){
                            ...
                            $affiliatepress_debug_log_msg = sprintf( 'Commission #%s successfully marked as rejected, after order #%s was refunded.', $affiliatepress_ap_commission_id, $affiliatepress_payment_id );
        ...
        /**
         * Function For aff teject commission
         *
         * @param  int $affiliatepress_payment_id
         * @param  string $affiliatepress_new_data
         * @param  string $affiliatepress_old_data
         * @return void
         */
        function affiliatepress_reject_commission_on_fail_pms( $affiliatepress_payment_id, $affiliatepress_new_data, $affiliatepress_old_data ) {
            global $AffiliatePress,$affiliatepress_tbl_ap_affiliate_commissions,$affiliatepress_commission_debug_log_id;

            $affiliatepress_payment_id = !empty($affiliatepress_payment_id) ? $affiliatepress_payment_id : 0;

            if ( ! isset( $affiliatepress_new_data['status'] ) || $affiliatepress_new_data['status'] != 'failed' ){
               return;
            }
                ...
                foreach($affiliatepress_all_commission_data as $affiliatepress_commissition_data){
                    ...
                    if(!empty($affiliatepress_commissition_data)){
                        ...
                        if($affiliatepress_ap_commission_id != 0){
                            ...
                            $this->affiliatepress_update_record($affiliatepress_tbl_ap_affiliate_commissions, $affiliatepress_commission_data, array( 'ap_commission_id' => $affiliatepress_ap_commission_id ));
                            $affiliatepress_debug_log_msg = sprintf( 'Commission #%s successfully marked as rejected, after order #%s failed or was cancelled.', $affiliatepress_ap_commission_id, $affiliatepress_payment_id );
        ...
        /**
         * Function For add paid membership subscription
         *
         * @param  int $affiliatepress_payment_id
         * @return void
         */
        function affiliatepress_reject_commission_on_delete_pms( $affiliatepress_payment_id ) {
                ...
                foreach($affiliatepress_all_commission_data as $affiliatepress_commissition_data){
                    ...
                    if(!empty($affiliatepress_commissition_data)){
                        ...
                        if($affiliatepress_ap_commission_id != 0){
                            ...
                            $this->affiliatepress_update_record($affiliatepress_tbl_ap_affiliate_commissions, $affiliatepress_commission_data, array( 'ap_commission_id' => $affiliatepress_ap_commission_id ));
                            $affiliatepress_debug_log_msg = sprintf( 'Commission #%s successfully marked as rejected, after order #%s was deleted.', $affiliatepress_ap_commission_id, $affiliatepress_payment_id );
