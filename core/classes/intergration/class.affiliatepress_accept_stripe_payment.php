    ...
    class affiliatepress_accept_stripe_payments Extends AffiliatePress_Core{
        ...
        */
        ...
        function affiliatepress_accept_stripe_payments_add_commission($affiliatepress_order_data, $affiliatepress_charge )
        {
            ...
            $affiliatepress_affiliate_id = apply_filters( 'affiliatepress_get_affiliate_id', $affiliatepress_affiliate_id, $this->affiliatepress_integration_slug, array('order_id'=>$affiliatepress_order_id) ,$affiliatepress_order_data,$affiliatepress_customer_args );
            ...
            else
            {
                ...
                if(isset($affiliatepress_order_data['coupon']) && !empty($affiliatepress_order_data['coupon'])){
                    $affiliatepress_coupon_discount = isset($affiliatepress_order_data['coupon']['discount'] ) ? floatval($affiliatepress_order_data['coupon']['discount']) : 0;
                    $affiliatepress_coupon_type = isset($affiliatepress_order_data['coupon']['discount_type'] ) ? sanitize_text_field($affiliatepress_order_data['coupon']['discount_type']) : '';
                    $affiliatepress_coupon_type = ($affiliatepress_coupon_type === 'perc') ? 'percentage' : 'fixed';
                   
                    if($affiliatepress_coupon_type === "percentage"){
                        $affiliatepress_coupon_amount = ($affiliatepress_amount * $affiliatepress_coupon_discount) / 100;
                    } else {
                        $affiliatepress_coupon_amount = $affiliatepress_coupon_discount;
                    }
            ...
            $affiliatepress_visit_id = apply_filters( 'affiliatepress_get_visit_id', $affiliatepress_visit_id, $affiliatepress_affiliate_id, $this->affiliatepress_integration_slug, array('order_id'=>$affiliatepress_order_id) ,$affiliatepress_order_data ,$affiliatepress_args, $affiliatepress_commission_rules,$affiliatepress_customer_args); 

            $affiliatepress_commisison_other_details = array();
            $affiliatepress_commisison_other_details  = apply_filters( 'affiliatepress_get_commisison_other_details',$affiliatepress_commisison_other_details,$affiliatepress_affiliate_id, $affiliatepress_visit_id ,$this->affiliatepress_integration_slug, $affiliatepress_order_id ,$affiliatepress_order_data,$affiliatepress_args, $affiliatepress_commission_rules,$affiliatepress_customer_args );

            $affiliatepress_commission_type  = apply_filters( 'affiliatepress_modify_commission_type',$affiliatepress_commission_type,$affiliatepress_affiliate_id,  $affiliatepress_visit_id ,$this->affiliatepress_integration_slug ,$affiliatepress_order_id ,$affiliatepress_order_data, $affiliatepress_args, $affiliatepress_commission_rules,$affiliatepress_customer_args );
